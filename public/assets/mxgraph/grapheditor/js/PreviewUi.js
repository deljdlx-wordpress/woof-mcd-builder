 ...
 */
PreviewUI = function(editor, container, lightbox)
{
...
mxUtils.extend(PreviewUI, mxEventSource);

/**
 * Global config that specifies if the compact UI elements should be used.
 */
 PreviewUI.compactUi = true;

/**
 * Specifies the size of the split bar.
 */
PreviewUI.prototype.splitSize = (mxClient.IS_TOUCH || mxClient.IS_POINTER) ? 12 : 8;

/**
 * Specifies the height of the menubar. Default is 30.
 */
PreviewUI.prototype.menubarHeight = 30;

/**
 * Specifies the width of the format panel should be enabled. Default is true.
 */
PreviewUI.prototype.formatEnabled = true;

/**
 * Specifies the width of the format panel. Default is 240.
 */
PreviewUI.prototype.formatWidth = 240;

/**
 * Specifies the height of the toolbar. Default is 38.
 */
PreviewUI.prototype.toolbarHeight = 38;

/**
 * Specifies the height of the footer. Default is 28.
 */
PreviewUI.prototype.footerHeight = 28;

/**
 * Specifies the height of the optional sidebarFooterContainer. Default is 34.
 */
PreviewUI.prototype.sidebarFooterHeight = 34;

/**
 * Specifies the position of the horizontal split bar. Default is 240 or 118 for
 * screen widths <= 640px.
 */
PreviewUI.prototype.hsplitPosition = (screen.width <= 640) ? 118 : ((urlParams['sidebar-entries'] != 'large') ? 212 : 240);

/**
 * Specifies if animations are allowed in <executeLayout>. Default is true.
 */
PreviewUI.prototype.allowAnimation = true;

/**
 * Default is 2.
 */
PreviewUI.prototype.lightboxMaxFitScale = 2;

/**
 * Default is 4.
 */
PreviewUI.prototype.lightboxVerticalDivider = 4;

/**
 * Specifies if single click on horizontal split should collapse sidebar. Default is false.
 */
PreviewUI.prototype.hsplitClickEnabled = false;

/**
 * Installs the listeners to update the action states.
 */
PreviewUI.prototype.init = function()
{
	var graph = this.editor.graph;
 ...
 */
PreviewUI.prototype.installShapePicker = function()
{
	var graph = this.editor.graph;
	var ui = this;
 ...
 */
PreviewUI.prototype.showShapePicker = function(x, y, source, callback, direction)
{
 ...
 * Creates a temporary graph instance for rendering off-screen content.
 */
PreviewUI.prototype.getCellsForShapePicker = function(cell)
{
 ...
 * Creates a temporary graph instance for rendering off-screen content.
 */
PreviewUI.prototype.hideShapePicker = function(cancel)
{
 ...
 * Returns true if the given event should start editing. This implementation returns true.
 */
PreviewUI.prototype.onKeyDown = function(evt)
{
	var graph = this.editor.graph;
 ...
 * Returns true if the given event should start editing. This implementation returns true.
 */
PreviewUI.prototype.onKeyPress = function(evt)
{
	var graph = this.editor.graph;
 ...
 * Returns true if the given event should start editing. This implementation returns true.
 */
PreviewUI.prototype.isImmediateEditingEvent = function(evt)
{
	return true;
};
 ...
 */
PreviewUI.prototype.getCssClassForMarker = function(prefix, shape, marker, fill)
{
	var result = '';
 ...
 */
PreviewUI.prototype.createMenus = function()
{
	return null;
};
 ...
 */
PreviewUI.prototype.updatePasteActionStates = function()
{
	var graph = this.editor.graph;
 ...
 * Hook for allowing selection and context menu for certain events.
 */
PreviewUI.prototype.initClipboard = function()
{
	var ui = this;
 ...
 */
PreviewUI.prototype.lazyZoomDelay = 20;

/**
 * Delay before update of DOM when using preview.
 */
PreviewUI.prototype.wheelZoomDelay = 400;

/**
 * Delay before update of DOM when using preview.
 */
PreviewUI.prototype.buttonZoomDelay = 600;

/**
 * Initializes the infinite canvas.
 */
PreviewUI.prototype.initCanvas = function()
{
 ...
 * Creates a temporary graph instance for rendering off-screen content.
 */
PreviewUI.prototype.addChromelessToolbarItems = function(addButton)
{
	addButton(mxUtils.bind(this, function(evt)
	{
 ...
 * Creates a temporary graph instance for rendering off-screen content.
 */
PreviewUI.prototype.isPagesEnabled = function()
{
 ...
 * Creates a temporary graph instance for rendering off-screen content.
 */
PreviewUI.prototype.createTemporaryGraph = function(stylesheet)
{
 ...
 * 
 */
PreviewUI.prototype.addChromelessClickHandler = function()
{
 ...
 * 
 */
PreviewUI.prototype.toggleFormatPanel = function(visible)
{
 ...
 */
PreviewUI.prototype.lightboxFit = function(maxHeight)
{
 ...
 */
PreviewUI.prototype.isDiagramEmpty = function()
{
 ...
 * Hook for allowing selection and context menu for certain events.
 */
PreviewUI.prototype.isSelectionAllowed = function(evt)
{
 ...
 */
PreviewUI.prototype.addBeforeUnloadListener = function()
{
	// Installs dialog if browser window is closed without saving
	// This must be disabled during save and image export
 ...
 */
PreviewUI.prototype.onBeforeUnload = function()
{
 ...
 */
PreviewUI.prototype.open = function()
{
 ...
 */
PreviewUI.prototype.showPopupMenu = function(fn, x, y, evt)
{
 ...
 */
PreviewUI.prototype.setCurrentMenu = function(menu, elt)
{
 ...
 */
PreviewUI.prototype.resetCurrentMenu = function()
{
 ...
 */
PreviewUI.prototype.hideCurrentMenu = function()
{
 ...
 */
PreviewUI.prototype.updateDocumentTitle = function()
{
 ...
 * Updates the document title.
 */
PreviewUI.prototype.createHoverIcons = function()
{
 ...
 */
PreviewUI.prototype.redo = function()
{
	try
	{
		var graph = this.editor.graph;
 ...
 * Returns the URL for a copy of this editor with no state.
 */
PreviewUI.prototype.undo = function()
{
	try
	{
		var graph = this.editor.graph;
 ...
 * Returns the URL for a copy of this editor with no state.
 */
PreviewUI.prototype.canRedo = function()
{
 ...
 * Returns the URL for a copy of this editor with no state.
 */
PreviewUI.prototype.canUndo = function()
{
 ...
 * 
 */
PreviewUI.prototype.getEditBlankXml = function()
{
 ...
 * Returns the URL for a copy of this editor with no state.
 */
PreviewUI.prototype.getUrl = function(pathname)
{
 ...
 */
PreviewUI.prototype.setScrollbars = function(value)
{
	var graph = this.editor.graph;
 ...
 */
PreviewUI.prototype.hasScrollbars = function()
{
 ...
 */
PreviewUI.prototype.resetScrollbars = function()
{
	var graph = this.editor.graph;
 ...
 */
PreviewUI.prototype.setPageVisible = function(value)
{
	var graph = this.editor.graph;
 ...
 * Loads the stylesheet for this graph.
 */
PreviewUI.prototype.setBackgroundColor = function(value)
{
 ...
 * Loads the stylesheet for this graph.
 */
PreviewUI.prototype.setFoldingEnabled = function(value)
{
 ...
 * Loads the stylesheet for this graph.
 */
PreviewUI.prototype.setPageFormat = function(value)
{
 ...
 * Loads the stylesheet for this graph.
 */
PreviewUI.prototype.setPageScale = function(value)
{
 ...
 * Loads the stylesheet for this graph.
 */
PreviewUI.prototype.setGridColor = function(value)
{
 ...
 */
PreviewUI.prototype.addUndoListener = function()
{
...
*/
PreviewUI.prototype.updateActionStates = function()
{
	var graph = this.editor.graph;
...
PreviewUI.prototype.zeroOffset = new mxPoint(0, 0);

PreviewUI.prototype.getDiagramContainerOffset = function()
{
 ...
 */
PreviewUI.prototype.refresh = function(sizeDidChange)
{
 ...
 */
PreviewUI.prototype.createTabContainer = function()
{
	return null;
};
 ...
 * Creates the required containers.
 */
PreviewUI.prototype.createDivs = function()
{
 ...
 */
PreviewUI.prototype.createSidebarFooterContainer = function()
{
	return null;
};
 ...
 * Creates the required containers.
 */
PreviewUI.prototype.createUi = function()
{
	// Creates menubar
 ...
 */
PreviewUI.prototype.createStatusContainer = function()
{
 ...
 * Creates a new toolbar for the given container.
 */
PreviewUI.prototype.setStatusText = function(value)
{
 ...
 * Creates a new toolbar for the given container.
 */
PreviewUI.prototype.createToolbar = function(container)
{
 ...
 */
PreviewUI.prototype.createSidebar = function(container)
{
 ...
 * Creates a new sidebar for the given container.
 */
PreviewUI.prototype.createFormat = function(container)
{
 ...
 */
PreviewUI.prototype.createFooter = function()
{
 ...
 */
PreviewUI.prototype.createDiv = function(classname)
{
 ...
 * Updates the states of the given undo/redo items.
 */
PreviewUI.prototype.addSplitHandler = function(elt, horizontal, dx, onChange)
{
	var start = null;
	var initial = null;
 ...
 * @param {number} dy Y-coordinate of the translation.
 */
PreviewUI.prototype.handleError = function(resp, title, fn, invokeFnOnClose, notFoundMessage)
{
 ...
 * @param {number} dy Y-coordinate of the translation.
 */
PreviewUI.prototype.showError = function(title, msg, btn, fn, retry, btn2, fn2, btn3, fn3, w, h, hide, onClose)
{
 ...
 */
PreviewUI.prototype.showDialog = function(elt, w, h, modal, closable, onClose, noScroll, transparent, onResize, ignoreBgClick)
{
 ...
 * Displays a print dialog.
 */
PreviewUI.prototype.hideDialog = function(cancel, isEsc)
{
	if (this.dialogs != null && this.dialogs.length > 0)
	{
 ...
 */
PreviewUI.prototype.ctrlEnter = function()
{
	var graph = this.editor.graph;
 ...
 */
PreviewUI.prototype.pickColor = function(color, apply)
{
	var graph = this.editor.graph;
 ...
 */
PreviewUI.prototype.openFile = function()
{
 ...
 */
PreviewUI.prototype.extractGraphModelFromHtml = function(data)
{
	var result = null;
 ...
 */
PreviewUI.prototype.extractGraphModelFromEvent = function(evt)
{
	var result = null;
	var data = null;
 ...
 */
PreviewUI.prototype.isCompatibleString = function(data)
{
	return false;
};
 ...
 * Adds the label menu items to the given menu and parent.
 */
PreviewUI.prototype.saveFile = function(forceDialog)
{
 ...
 */
PreviewUI.prototype.save = function(name)
{
	if (name != null)
	{
 ...
 */
PreviewUI.prototype.executeLayout = function(exec, animate, post)
{
	var graph = this.editor.graph;
 ...
 */
PreviewUI.prototype.showImageDialog = function(title, value, fn, ignoreExisting)
{
 ...
 * Hides the current menu.
 */
PreviewUI.prototype.showLinkDialog = function(value, btnLabel, fn)
{
 ...
 * Hides the current menu.
 */
PreviewUI.prototype.showDataDialog = function(cell)
{
	if (cell != null)
	{
 ...
 * Hides the current menu.
 */
PreviewUI.prototype.showBackgroundImageDialog = function(apply, img)
{
 ...
 * Loads the stylesheet for this graph.
 */
PreviewUI.prototype.setBackgroundImage = function(image)
{
 ...
 */
PreviewUI.prototype.confirm = function(msg, okFn, cancelFn)
{
 ...
 * Creates the keyboard event handler for the current graph and history.
 */
PreviewUI.prototype.createOutline = function(wnd)
{
...
PreviewUI.prototype.altShiftActions = {67: 'clearWaypoints', // Alt+Shift+C
 ...
 * Creates the keyboard event handler for the current graph and history.
 */
PreviewUI.prototype.createKeyHandler = function(editor)
{
	var editorUi = this;
	var graph = this.editor.graph;
 ...
 * Creates the keyboard event handler for the current graph and history.
 */
PreviewUI.prototype.destroy = function()
{
	if (this.editor != null)
	{
		this.editor.destroy();
